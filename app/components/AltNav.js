              ...
              <p>
                ...
                <strong>
                  <a
                    ...
                    rel="noopener noreferrer nofollow"
                  >
                    The Internet Didn{"'"}t Kill Counterculture—You Just Won
                    {"'"}t Find it on Instagram
                  </a>
                </strong>{" "}
                (Caroline Busta)
                <strong>
              ...
              <p>
                ...
                <strong>
                  ...
                  >
                    ...
                    contemporary topics at the bleeding edge of art, politics
                    and culture
                  </a>
                </strong>
                {'"'} <br />
            ...
            <div>
              ...
              <div className="" data-tags="">
                ...
                <p>
                  ...
                  to create a media space outside of the {'"'}physics{'"'} of
                  Web 2.0 platforms by hand-aggregating links and seeding a
                  community beyond&nbsp;
                  <em>the feed</em>. In the time since, we have built an
                  international member network and Discord server, staged many
                  IRL and digital/physical&nbsp;
                  <a
                  ...
                  experience of being online together during the extremely
                  online year of Y2K20.
                </p>
              </div>{" "}
              <br />
              <hr />{" "}
              <div className="" data-tags="">
                ...
                <br />
                <p>
                  NEW MODELS was founded in Berlin in 2018. Its initial aim was
                  to think outside of Web 2.0 feeds by hand-aggregating a cache
                  of information relevant to the culture sector ...
                  <br />
                  <br />
                </p>
              </div>{" "}
              ...
              <div className="" data-tags="">
                <p>
                  ...
                  industries. We first used https://newmodels.io, as a kind of
                  alt{" "}
                  <a
              ...
              <div className="" data-tags="">
                <p>
                  ...
                  on world building and online identity formation and the
                  premier of Richard Kennedy{"'"}s 2020 opera{" "}
                  <strong>
                    <a
                      href="https://newmodels.io/editorial/issue-2/fubu-fuku-an-opera-by-richard-kennedy"
                      rel="noopener noreferrer nofollow"
              ...
              <div className="" data-tags="">
                <p>
                  ...
                  subscription-gating some of our content via Patreon,
                  introducing the <strong>NM TopSoil</strong> show for more
                  free-form discussion about current events and{" "}
                  <strong>
                    <a
              ...
              <div className="" data-tags="">
                <p>
                  <br />
                  <br />
                  This small barrier (€5 / month) created a subscribing New
                  Models Community... which in turn led to us to start a Discord
                  server. Suddenly, New Models was no longer just a
                  creator-to-audience stream, but a mainframe for processing
                  information free from the extractive properties of Clearnet
                  spaces. We began referring to this ecosystem as a {'"'}
                  <a
              ...
              <div className="" data-tags="">
                <p>
                  ...
                  initiatives aimed at {'"'}devirtualizing{'"'} traces of NM
                  {"'"}s digital enclave into something physical and therefore
                  less vulnerable to erasure. In 2021, the NM community produced
                  the{" "}
                  <strong>
                    <a
                      href="https://shop.newmodels.io/product/codex-y2k20-2"
              ...
              <div className="" data-tags="">
                <p>
                  ...
                  feeds organized by algorithms optmizing for target-margets,
                  wide fluctuations in access and reach. For NM, the problem to
                  solve was no longer exiting legacy media or Web 2 but
                  establishing a new, more resiliant network beyond them.
                  <br />
                  <br />
                </p>
              </div>{" "}
              ...
              <div className="" data-tags="">
                <p>
                  <em>
                    ...
                    creator communities spilling into each other, sharing flows
                    of content, 2021.
                  </em>
                </p>
              </div>{" "}
              <div className="nm" data-tags="">
                <p>
                  ...
                  In equal parts,{" "}
                  <strong>
                    New Models creates content, community, and the structures
